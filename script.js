...
$(function() { // $(document).ready(function()
	...
	$("#college").empty();
	$.each(colleges, function(i, val) {
		$("#college").append($("<option value='" + colleges[i] + "'>" + colleges[i] + "</option>"));
	}); 
	$.each(departments[0], function(i, val) {
		$("#department").append($("<option value='" + departments[0][i] + "'>" + departments[0][i] + "</option>"));
	});

	$("#college").change(function() {
		index = $("#college").find(':selected').index();
		$("#department").empty();
		$.each(departments[index], function(i, val) {
			$("#department").append($("<option value='" + departments[index][i] + "'>" + departments[index][i] + "</option>"));
		}); 
	});
});